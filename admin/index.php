...
echo "<p>提交时间：".$row[uptime]."</p><p>希望播放的时间：".$row[time]."</p><p>歌曲名：".$row[name]."</p><p>点歌人：".$row[user]."</p><p>送给：".$row[to]."</p><p>留言：".$row[message]."</p><a href='http://r.smxybbs.net/admin/delmusic.php?id=".$id."'>删除</a><hr/>";
$id=$id+1;
}
mysql_close($con);
?>	
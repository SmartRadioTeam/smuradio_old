...
window.location.href="http://mr.smxybbs.net/list.php";
}
-->
</script><head><meta http-equiv="Content-Type" content="text/html; charset=gbk">
<title>歌曲列表 - 三明学院点歌台</title>
...
<div id="lay_bg" class="lay_background"">
    <img class="lay_background_img" id="lay_bg_img" src="http://img.smxydxslt.com/radio/b7.jpg">
</div>
<script type="text/javascript">
resizeBackground();
...
$query = mysql_query($sql,$con);
while($row=mysql_fetch_array($query)){
echo "<thead><tr><td>".$row[name]."</td></tr> </thead>";
}
mysql_close($con);
?>	
</table>
